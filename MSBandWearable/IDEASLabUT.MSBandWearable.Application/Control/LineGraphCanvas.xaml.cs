...
namespace IDEASLabUT.MSBandWearable.Application.Control
{
    /// <summary>
        ...
        public void AddLineGraph(double yoffset = 0.0, string label = "", SolidColorBrush brush = null)
        {
            ...
            if (label != "")
            {
                ...
                Binding binding = new Binding()
                {
                    ...
                    Converter = new Converter.LineGraphLabelConverter(),   // Format the value as 'Label: Value'
