...
namespace IDEASLabUT.MSBandWearable.Sensor
{
    ...
    public abstract class BaseSensor<SensorEvent, SensorReading> where SensorEvent : BaseEvent, new() where SensorReading  : IBandSensorReading
    {
        ...
        protected BaseSensor(SensorType? sensorType, ILogger logger, IBandClientService msBandService, ISubjectViewService subjectViewService, INtpSyncService ntpSyncService, Func<IBandSensorManager, IBandSensor<SensorReading>> bandSensorSupplier)
        {
        ...
        public Func<Task> SensorModelChanged { get; set; }
